// Generated by @wagmi/cli@1.3.0 on 7/4/2023 at 1:47:31 AM
...
export const erc721DropABI = [
  ...
  { type: 'error', inputs: [], name: 'BurnNotAllowed' },
  ...
  { type: 'error', inputs: [], name: 'InvalidSupply' },
  ...
  { type: 'error', inputs: [], name: 'PhaseSupplyOverflow' },
  ...
  },
  {
    ...
    type: 'function',
    inputs: [
      { name: '_phaseIndex', internalType: 'uint16', type: 'uint16' },
      { name: '_to', internalType: 'address[]', type: 'address[]' },
      { name: '_quantities', internalType: 'uint64[]', type: 'uint64[]' },
    ],
    name: 'airdrop',
    outputs: [],
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_operatorFilter', internalType: 'address', type: 'address' },
    ],
    name: 'initialize',
    outputs: [],
  },
  ...
  },
  {
    ...
    name: 'maxTotalSupply',
    outputs: [
      { name: '_maxTotalSupply', internalType: 'uint64', type: 'uint64' },
    ],
  },
  {
    stateMutability: 'payable',
    type: 'function',
    inputs: [
      { name: '_phaseIndices', internalType: 'uint16[]', type: 'uint16[]' },
      { name: '_quantities', internalType: 'uint64[]', type: 'uint64[]' },
  ...
  },
  {
    stateMutability: 'payable',
    type: 'function',
    inputs: [{ name: '_quantity', internalType: 'uint64', type: 'uint64' }],
    name: 'mint',
    outputs: [],
  },
  {
  ...
  },
  {
    ...
    type: 'function',
    inputs: [{ name: '_owner', internalType: 'address', type: 'address' }],
    name: 'numberMintedPerPhases',
    outputs: [
      { name: '_perPhases', internalType: 'uint256[]', type: 'uint256[]' },
    ],
  },
  {
    stateMutability: 'view',
    ...
    outputs: [
      {
        ...
        components: [
          ...
          { name: 'totalMinted', internalType: 'uint64', type: 'uint64' },
  ...
  },
  {
    stateMutability: 'nonpayable',
    type: 'function',
    inputs: [{ name: '_burnable', internalType: 'bool', type: 'bool' }],
    name: 'setBurnable',
    outputs: [],
  },
  {
    ...
    type: 'function',
    inputs: [
      { name: '_globalMaxPerWallet', internalType: 'uint64', type: 'uint64' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { name: '_resetEligibility', internalType: 'bool', type: 'bool' },
    ],
    name: 'setPhases',
    outputs: [],
  },
